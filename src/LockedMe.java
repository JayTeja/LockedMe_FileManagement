...
public class LockedMe {
    ...
    private static final String WELCOME_PROMPT =
            "\n ############## Welcome to LockedMe.com ##############"+
                    "\n############## Designed and Created By Jay Teja ##############\n";

    private static final String MAIN_MENU_PROMPT =
            "\nMAIN MENU -Choose From Below Options: \n"+
                    "1 -> List All The Available Files In Directory\n"+
                    "2 -> Add Or Delete Or Search a File\n"+
                    "3 -> Exit Program";
